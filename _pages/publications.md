...
[J5] **Yapeng Li**, Peng Xu, Mingzhen Li, Tsung-Yi Ho, Bei Yu, Tinghuan Chen, "Analog Circuit Representation Learning Informed by Kirchhoff's Current Law", accepted by IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD).

[J4] Peng Xu, **Yapeng Li**, Tinghuan Chen, Tsung-Yi Ho, Bei Yu, "Ckt2Vec: Efficient Electrical Encoding for Analog Circuit Representations in Vector Space", accepted by IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD).
